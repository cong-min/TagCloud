...
;(function(win, doc) {
    ...
    TagCloud.prototype = {
        ...
        init: function(options) {
            var self = this;
            self.config = this._getConfig(options);
            ...
            self.mspeed = (function (mspeed) {    //滚动最大速度
                switch (mspeed) {
                    case "slow":
                        return 1.5;
                    case "normal":
            ...
            self.ispeed = (function (ispeed) {    //滚动初速度
                switch (ispeed) {
                    case "slow":
                        return 10;
                    case "normal":
        ...
        ready: function() {
            ...
            //鼠标在内移动
            var area = self.keep ? win : self.box;
    ...
    win.tagcloud = function (options) {
        ...
        var className = 'tagcloud', //默认classtagcloud
            element = doc.getElementsByClassName(className),
            ret = [];
